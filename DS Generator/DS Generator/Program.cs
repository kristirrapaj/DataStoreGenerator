...
namespace DS_Generator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string destPath = @"D:\Cristian\Generated FieldsConfigFiles";
        ...
        private static void GenerateModel(string destPath)
        {
            ...
            string schema = "retepa";
            IDataStore dataStore = new global::DataStore.Oracle.STGeomDataStore.OracleSTGeomDataStore(connStr: connStr, schema: schema);
        ...
        private static void GenerateGridConfigs(string destPath, string [] tables)
        {
            ...
            string connStr = "Data Source=vmsql2016dev;Initial Catalog=RETEAC;Persist Security Info=True;User ID=reteac;Password=reteac";
            string schema = "RETEAC";
            ...
            SqlGenerator generator = new SqlGenerator(dataStore);
