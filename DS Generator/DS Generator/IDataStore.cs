...
#warning Las3: Non deve essere esposta a classi al di fuori dei DataStore
    ...
    string ISNULL_FUNC_NAME { get; }

    string CONCAT_STRING_KEYWORD { get; }

    string START_ESCAPE_CHAR { get; }

    string END_ESCAPE_CHAR { get; }
    ...
    /// <param name="destTableName"></param>
    /// <returns></returns>
    string GetUpdateScript(string srcTableName, string destTableName, ICollection<DataColumn> updateColumns,
    ...
    /// <returns></returns>
    string GetEnvelopeComponentScript(EnvelopeComponentEnum component, string shapeField = null,
